...
**Explanation:** [Detailed explanation of 100 to 500 words according to {difficulty} level in simple language]
**Example:** [Real-world or clinical/technical example, minimum one example, maximum three examples according to {difficulty} level]
